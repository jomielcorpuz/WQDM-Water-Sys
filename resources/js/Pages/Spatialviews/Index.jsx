...
const currentData = filteredData.slice(indexOfFirstItem, indexOfLastItem);
  ...
  >
    ...
    <div className="flex flex-wrap gap-1 py-12">
      <div className="w-full lg:w-[80%] md:w-[90%]  mx-auto sm:px-6 lg:px-8 ">


        {/* Map section */}
        <div className="bg-white w-full m-2 border rounded overflow-hidden shadow-sm sm:rounded-lg ">
