    ...
    <div className="py-12">
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-wrap space-x-4 justify-end items-center">
          ...
          {/* Map section */}
          <div className="bg-white border rounded w-full m-4  overflow-hidden shadow-sm sm:rounded-lg  ">
            <div className="p-4 bg-white dark:bg-gray-800">
              <h1 className="text-2xl font-bold mb-4">Water Sites Map</h1>
              <div className="flex justify-end ">
                <h1 className="text-2xl font-bold mb-4">View by:</h1>
              ...
              {loading ? (
                ...
                <div className="flex flex-row">
                  {/* Map */}
                  <div ref={mapRef} className="w-full h-96 border rounded mt-4 mb-4"></div>
                </div>
              )}
            </div>
          </div>
          ...
          {/* Details Section */}
          <div className="bg-white p-6 m-2 overflow-hidden shadow-sm sm:rounded-lg border rounded w-full ">
            <h1 className="text-2xl font-bold mb-4">Sites Reading</h1>
            <div className="flex flex-col justify-center items-center">
              <div className="w-full h-96 p-4 border rounded shadow bg-gray-200">
                {selectedMarkerData ? (
                  <div>
